...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/user/algomez/lhe/RPVStop_1000002_100.0_n1000000-p0_decayed_1000002_100.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('genfragment.py nevts:-1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:gen_RPVStop100_ISR2j_13TeV_Qcut'+str(THEQCUT)+'.root'),
